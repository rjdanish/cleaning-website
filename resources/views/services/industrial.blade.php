...
@section('content')
    <div class="container py-5">
        <div class="text-center mb-5">
            ...
            <h2 class="fw-bold text-primary">Industrial Cleaning Services</h2>
            <p class="text-muted mx-auto" style="max-width: 700px;">
                Boost productivity with a pristine professional workspace. Our customized industrial cleaning ensures a
